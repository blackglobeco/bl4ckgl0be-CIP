...
// ── MBJB: Majlis Bandaraya Johor Bahru ──────────────────────────────────
  ...
  const mbjbCameras = [
    ...
    { id: 'mbjb-L6C1',  lat: 1.4674, lng: 103.7270, name: 'Jalan Abu Bakar Sultan / Country Garden (L6C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L06_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L6C2',  lat: 1.4674, lng: 103.7271, name: 'Jalan Abu Bakar Sultan / Country Garden (L6C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L06_Cam2'), source: 'MBJB' },
    ...
    { id: 'mbjb-L7C1',  lat: 1.4582, lng: 103.7427, name: 'Jalan Abu Bakar Sultan / Dataran Bandaraya (L7C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L07_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L7C2',  lat: 1.4581, lng: 103.7429, name: 'Jalan Abu Bakar Sultan / Dataran Bandaraya (L7C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L07_Cam2'), source: 'MBJB' },
    ...
    { id: 'mbjb-L25C1', lat: 1.5507, lng: 103.7861, name: 'Jalan Mutiara Emas Utama Roundabout (L25C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L25_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L25C2', lat: 1.5506, lng: 103.7859, name: 'Jalan Mutiara Emas Utama Roundabout (L25C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L25_Cam2'), source: 'MBJB' },
    ...
    { id: 'mbjb-L3C1',  lat: 1.4626, lng: 103.7629, name: 'Jalan Wong Ah Fook / JBCC (L3C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L03_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L3C2',  lat: 1.4628, lng: 103.7628, name: 'Jalan Wong Ah Fook / JBCC (L3C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L03_Cam2'), source: 'MBJB' },
    ...
    { id: 'mbjb-L9C1',  lat: 1.4578, lng: 103.7635, name: 'Lorong Jalan Dhoby Parking (L9C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L09_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L9C2',  lat: 1.4578, lng: 103.7636, name: 'Lorong Jalan Dhoby Parking (L9C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L09_Cam2'), source: 'MBJB' },
    ...
    { id: 'mbjb-L10C1', lat: 1.4586, lng: 103.7625, name: 'Jalan Abdullah Ibrahim / Ungku Puan (L10C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L10_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L10C2', lat: 1.4585, lng: 103.7626, name: 'Jalan Abdullah Ibrahim / Ungku Puan (L10C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L10_Cam2'), source: 'MBJB' },

    // L11 – Jalan Abdullah Ibrahim (Persada)
    // Persada Johor International Convention Centre Wikipedia: 1.461833, 103.761583
    { id: 'mbjb-L11C1', lat: 1.4613, lng: 103.7608, name: 'Jalan Abdullah Ibrahim / Persada (L11C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L11_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L11C2', lat: 1.4613, lng: 103.7609, name: 'Jalan Abdullah Ibrahim / Persada (L11C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L11_Cam2'), source: 'MBJB' },
    ...
    { id: 'mbjb-L12C1', lat: 1.4734, lng: 103.7626, name: 'Jalan Tebrau / Lingkaran Dalam (L12C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L12_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L12C2', lat: 1.4733, lng: 103.7626, name: 'Jalan Tebrau / Lingkaran Dalam (L12C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L12_Cam2'), source: 'MBJB' },

    // L13 – Jalan Tebrau / Jalan Bakar Batu
    // Kampung Bakar Batu Wikipedia: 1.50023, 103.77891
    { id: 'mbjb-L13C1', lat: 1.4951, lng: 103.7660, name: 'Jalan Tebrau / Jalan Bakar Batu (L13C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L13_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L13C2', lat: 1.4950, lng: 103.7660, name: 'Jalan Tebrau / Jalan Bakar Batu (L13C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L13_Cam2'), source: 'MBJB' },
    ...
    { id: 'mbjb-L15C1', lat: 1.5042, lng: 103.7643, name: 'Jalan Tebrau / Jalan Bunga Ros (L15C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L15_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L15C2', lat: 1.5043, lng: 103.7642, name: 'Jalan Tebrau / Jalan Bunga Ros (L15C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L15_Cam2'), source: 'MBJB' },
    ...
    { id: 'mbjb-L16C1', lat: 1.5207, lng: 103.7607, name: 'Jalan Tebrau / Susur EDL (L16C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L16_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L16C2', lat: 1.5207, lng: 103.7608, name: 'Jalan Tebrau / Susur EDL (L16C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L16_Cam2'), source: 'MBJB' },
    ...
    { id: 'mbjb-L17C1', lat: 1.5255, lng: 103.7724, name: 'Jalan Pandan / Jalan Kangkar Tebrau (L17C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L17_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L17C2', lat: 1.5255, lng: 103.7723, name: 'Jalan Pandan / Jalan Kangkar Tebrau (L17C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L17_Cam2'), source: 'MBJB' },
    ...
    { id: 'mbjb-L18C1', lat: 1.5321, lng: 103.7820, name: 'Jalan Pandan / The Store (L18C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L18_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L18C2', lat: 1.5319, lng: 103.7819, name: 'Jalan Pandan / The Store (L18C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L18_Cam2'), source: 'MBJB' },
    ...
    { id: 'mbjb-L19C1', lat: 1.5532, lng: 103.8016, name: 'Desa Jaya / IKEA Tebrau (L19C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L19_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L19C2', lat: 1.5532, lng: 103.8015, name: 'Desa Jaya / IKEA Tebrau (L19C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L19_Cam2'), source: 'MBJB' },
    
    // ── Jalan Ibrahim Sultan ke Pasar Pelangi ─────────────────────────────
 
    // L14 – Permas Jaya
    // Permas Jaya Wikipedia: 1°29′54.3″N 103°49′10.0″E = 1.498417, 103.819444
    { id: 'mbjb-L14C1', lat: 1.4946, lng: 103.8010, name: 'Permas Jaya (L14C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L14_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L14C2', lat: 1.4945, lng: 103.8011, name: 'Permas Jaya (L14C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L14_Cam2'), source: 'MBJB' },
    ...
    { id: 'mbjb-L20C1', lat: 1.4650, lng: 103.7762, name: 'Jalan Ibrahim Sultan / Stulang Laut (L20C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L20_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L20C2', lat: 1.4650, lng: 103.7763, name: 'Jalan Ibrahim Sultan / Stulang Laut (L20C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L20_Cam2'), source: 'MBJB' },
    ...
    { id: 'mbjb-L21C1', lat: 1.4593, lng: 103.7677, name: 'Jalan Ismail Sultan / Jalan Jim Quee (L21C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L21_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L21C2', lat: 1.4593, lng: 103.7676, name: 'Jalan Ismail Sultan / Jalan Jim Quee (L21C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L21_Cam2'), source: 'MBJB' },
    ...
    { id: 'mbjb-L22C1', lat: 1.4653, lng: 103.7640, name: 'Jalan Jim Quee / CIQ (L22C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L22_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L22C2', lat: 1.4651, lng: 103.7641, name: 'Jalan Jim Quee / CIQ (L22C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L22_Cam2'), source: 'MBJB' },
    ...
    { id: 'mbjb-L23C1', lat: 1.4624, lng: 103.7737, name: 'Jalan Ismail Sultan / Jalan Ibrahim Sultan (L23C1)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L23_Cam1'), source: 'MBJB' },
    { id: 'mbjb-L23C2', lat: 1.4623, lng: 103.7736, name: 'Jalan Ismail Sultan / Jalan Ibrahim Sultan (L23C2)', city: 'Johor Bahru', country: 'Malaysia', feed_url: MBJB('L23_Cam2'), source: 'MBJB' },
